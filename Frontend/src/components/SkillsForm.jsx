  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='bg-blue-50 p-3 rounded-lg'>
            <p className='text-sm text-blue-800'> <strong>Tip:</strong>Add 8-12 Relevant Skills. Includes both Technical (programming languages, tools) and Soft Skills (Leadership, communication etc..)</p>
        </div>
