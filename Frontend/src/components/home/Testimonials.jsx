...
const Testimonials = () => {
  ...
  // Card Component with Hover Motion
  const CreateCard = ({ card }) => (
    <motion.div
      ...
      className="p-4 rounded-lg mx-4 shadow hover:shadow-xl transition-all duration-200 w-72 shrink-0 bg-white"
    >
  ...
  return (
    <>
      ...
      >
        ...
        <motion.div variants={fadeUp}>
          <Title
            ...
            description="Hear what our users say about us. We're always improving — share your valuable review!"
          />
        </motion.div>
      </motion.div>
      ...
      >
        ...
        <div className="absolute right-0 top-0 h-full w-20 md:w-40 bg-gradient-to-l from-white to-transparent pointer-events-none z-10"></div>
      </motion.div>
